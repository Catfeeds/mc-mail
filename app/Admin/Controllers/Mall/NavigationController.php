...
//        'goods' => '商品ID',
    ...
    public function create()
    {
        ...
        return view('admin::home.navigation-create', ['types' => $this->types,'tops'=>$tops]);
    }
    ...
    public function edit(Navigation $navigation)
    {
        ...
        if($navigation->category) {
            $categorys = (new ItemCategory())->where('parent_id', '=', $navigation->category->parent_id)->where('platform_id', '=', 1)->get();
        }
        else{
            $categorys =[];
        }
            return view('admin::home.navigation-edit', compact('navigation', 'types', 'tops', 'categorys'));
