...
@section('content')
    @include('admin::search.orders-orders',['resetUrl' => route('admin::orders.receiving')])

    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">待收货订单</h3>

                    @include('admin::widgets.filter-btn-group', ['resetUrl' => route('admin::orders.receiving')])
                </div>
