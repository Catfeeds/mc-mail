    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form id="post-form" class="form-horizontal" action="{{ route('admin::service.update',$service->id) }}" method="post" enctype="multipart/form-data" pjax-container>
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="box-body">
                        <div class="fields-group">
                            <div class="form-group">
                                <label for="name" id="labelId" class="col-sm-2 control-label">服务条款</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <textarea name="content" id="content"  hidden>{{ $service->content }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
