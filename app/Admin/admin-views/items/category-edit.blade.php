                    ...
                    <div class="box-body">
                        <div class="fields-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control category" style="width: 100%;" name="parent_id" data-placeholder="选择 分类"  >
                                        <option value="0">顶级分类</option>
                                        @foreach($categories as $categorys)
                                            <option value="{{ $categorys->id }}" @if($category->parent_id == $categorys->id) selected @endif>{{ $categorys->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="name" name="name" value="{{ $category->name }}" class="form-control name" placeholder="输入 名称">
                                    </div>
                                </div>
                            </div>
                        </div>
