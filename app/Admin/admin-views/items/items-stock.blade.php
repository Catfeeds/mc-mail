                    ...
                    <table class="table">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td><a href="javascript:void(0);" data-id="{{ $item->id }}" class="change-price fa fa-edit">
                                        {!! $itemPresenter->price($item) !!}
                                    </a>
                                </td>
...
@section('script')
    ...
    $('.change-price').unbind('click').click(function() {
