...
class ItemController extends Controller
{
    ...
    public function index()
    {
        ...
        $items = Item::orderBy('order', 'asc')->withOrder($order)->orderBy('sort','desc')->paginate(10);
        $items->load('covers');
    ...
    public function search()
    {
        ...
        $keyword = "%{$key}%";
        $item = Item::where('title', 'like', $keyword)->where('status',1)->paginate($perPage = 10, $columns = ['*'], $pageName = 'page', $page);
